...
import {ICertificate, ICertificateResult, ICertificateView} from 'models/certificates';
...
export const deploymentFactory = Factory.Sync.makeFactory<IApplicationDeployment>({
...
export const deploymentDetailsFactory = Factory.Sync.makeFactory<IApplicationDeploymentDetails>({
  updatedBy: 'linus',
...
export const applicationDeploymentFilterFactory = Factory.Sync.makeFactory<IApplicationDeploymentFilters>({
  name: 'my-filter',
  affiliation: 'paas',
  default: true,
...
export const databaseSchemaViewFactory = Factory.Sync.makeFactory<IDatabaseSchemaView>({
  id: '123',
...
export const databaseSchemaInputFactory = Factory.Sync.makeFactory<IDatabaseSchemaInput>({
  application: 'application',
  description: null,
  environment: 'environment',
  discriminator: 'db',
...
export const databaseSchemaInputWithCreatedByFactory = Factory.Sync.makeFactory<IUpdateDatabaseSchemaInputWithCreatedBy>({
  id: '1234.1234.1234',
  discriminator: 'db',
  description: 'description',
  application: 'application',
...
export const createDatabaseSchemaResponseFactory = Factory.Sync.makeFactory<ICreateDatabaseSchemaResponse>({
  id: '123',
  jdbcUser: jdbcUserFactory.build()
});

export const certificateViewFactory = Factory.Sync.makeFactory<ICertificateView>({
  id: 123,
  dn: 'test',
...
export const certificateResultFactory = Factory.Sync.makeFactory<ICertificateResult>({
...
export const certificateInitialFactory = Factory.Sync.makeFactory<ICertificateState>({
  certificates: {
    certificates: [],
    totalCount: 0
  },
...
export const databaseSchemasFactory = Factory.Sync.makeFactory<IDatabaseSchemas>({
  databaseSchemas: [databaseSchemaFactory.build()]
});

export const deleteDatabaseSchemasResponseFactory = Factory.Sync.makeFactory<IDeleteDatabaseSchemasResponse>({
  failed: [],
  succeeded: []
});

export const userAndAffiliationsFactory = Factory.Sync.makeFactory<IUserAndAffiliations>({
  affiliations: ['paas'],
  id: '123',
  user: 'bob'
});

export const createDatabaseSchemaInputFactory = Factory.Sync.makeFactory<ICreateDatabaseSchemaInput>({
  affiliation: 'paas',
  application: 'app',
  createdBy: 'd36754',
  description: null,
...
export const netdebugViewStateInitialState = Factory.Sync.makeFactory<INetdebugViewState>({
  isFetching: false,
...
export const websealReduxStateFactory = Factory.Sync.makeFactory<IWebsealReduxState>({
...
export const affiliationViewStateFactory = Factory.Sync.makeFactory<IAffiliationViewState>({
