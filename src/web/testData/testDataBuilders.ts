...
import {
  ...
  ICertificateResult,
  ICertificateView,
} from 'web/models/certificates';
import { IDeploymentSpec, IMount } from 'web/models/DeploymentSpec';
...
import {
  ...
  IUserSettings,
} from 'web/models/UserSettings';
import { IAcl, IWebsealState } from 'web/models/Webseal';
import { ISchemasState } from 'web/screens/AffiliationViews/DatabaseView/state/reducers';
import { IWebsealReduxState } from 'web/screens/AffiliationViews/WebsealView/state/reducers';
import { ICertificateState } from 'web/screens/CertificateView/state/reducers';
import { INetdebugResult } from 'web/services/auroraApiClients';
import { IFilter } from 'web/services/DeploymentFilterService';
import { INetdebugViewState } from 'web/screens/NetdebugView/state/reducer';
...
import { IApplicationDeploymentData } from 'web/services/auroraApiClients/applicationDeploymentClient/query';
